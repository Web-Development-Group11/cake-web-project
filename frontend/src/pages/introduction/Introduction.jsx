          ...
          <div className={styles.center}>
            ...
            <div className={styles.content}>
              ...
              <div className={styles.content__text}>
                ...
                <p className={`${styles.content__paragraph} body--2`}>
                  Sứ mệnh của <strong className={`${styles.brandName} title--2`}>Bông Cake</strong> là đem đến niềm vui và hạnh phúc cho mọi người thông qua những chiếc bánh ngọt tinh tế và ngon miệng. Chúng tôi cam kết sử dụng những nguyên liệu tốt nhất, kỹ thuật nướng bánh hàng đầu, và lòng nhiệt huyết để tạo ra những sản phẩm chất lượng cao. Chúng tôi muốn mỗi chiếc bánh của chúng tôi là món quà ý nghĩa cho các dịp quan trọng trong cuộc sống của khách hàng.
                </p>
                <h3 className={`${styles.content__subhead} title--3`}>
                  Giá trị cốt lõi
                </h3>
                ...
                <p className={`${styles.content__paragraph} body--2`}>
                  Chất lượng: Chất lượng là yếu tố quan trọng nhất đối với <strong className={`${styles.brandName} title--2`}>Bông Cake</strong>. Chúng tôi sử dụng nguyên liệu tươi ngon và tuân thủ các tiêu chuẩn nghiêm ngặt trong quá trình sản xuất.
                </p>
                <p className={`${styles.content__paragraph} body--2`}>
                ...
                <p className={`${styles.content__paragraph} body--2`}>
                  <strong className={`${styles.brandName} title--2`}>Bông Cake</strong> xin chân thành cảm ơn sự ủng hộ của quý khách hàng, và chúng tôi hy vọng sẽ tiếp tục đồng hành cùng bạn trong những khoảnh khắc ngọt ngào và đặc biệt trong cuộc sống.
                </p>
              </div>
            </div>
          </div>
